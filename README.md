...
This is a small sampling of code that I wrote, extended, ported, or just played around with while volunteering as a CTA for the Fundamentals of Computing specialization on Coursera. Many of these were one-off projects for self-improvement or throw-away "doodles" created for fun.

These programs were written for use with Codeskulptor and can be run using the links below (press the triangle button at top left of associated page to run). The arc_parabolic program is probably the cleanest (It was meant to be shared with teenage coders). 
